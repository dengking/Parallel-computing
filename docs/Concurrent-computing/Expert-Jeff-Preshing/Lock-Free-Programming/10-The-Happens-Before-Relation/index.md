...
## Programmer从source的角度来理解*Happens-before* relation

> NOTE: Programmer从source code的角度来理解*Happens-before* relation
...
>
> 2、compiler生成的code能够保证single thread的正确
>
> 3、这再此提醒了我们: happens-before relation是基于effect而定义的，而不是基于statement in programmer order而定义的
...
## Ambiguity between the *happens-before* relation and the actual order of operations(happening before) 
